 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.shoesly.staging
 */

const BUNDLE_ID = 'com.shoesly'; // ios bundle id
const PACKAGE = 'com.shoesly'; // android package name
const NAME = 'Shoesly'; // app name
